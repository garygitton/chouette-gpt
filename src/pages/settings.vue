      ...
      <div class="max-w-2xl mx-auto space-y-6">
        ...
        <Card class="rounded-2xl border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-[#0b0f19]/70 backdrop-blur-xl shadow-lg mt-6">
          <CardHeader class="flex flex-row items-center space-x-2 pb-2">
            ...
            <CardTitle class="text-lg">À propos & Projet</CardTitle>
          </CardHeader>

          <CardContent class="space-y-6">
            <!-- Author section -->
            <div class="p-4 rounded-xl bg-slate-100/50 dark:bg-slate-900/50 border border-slate-200/50 dark:border-slate-850/50">
              <h3 class="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider mb-2">L'Auteur</h3>
            ...
            <!-- Project section -->
            <div class="p-4 rounded-xl bg-slate-100/50 dark:bg-slate-900/50 border border-slate-200/50 dark:border-slate-850/50">
              <h3 class="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider mb-2">Le Projet</h3>
              <div class="flex items-center justify-between">
                <div>
                  <p class="text-sm font-bold text-slate-900 dark:text-white">ChouetteGPT</p>
                  <p class="text-xs text-slate-500 dark:text-slate-400">IA locale s'exécutant entièrement dans le navigateur.</p>
                </div>
            ...
            <div class="flex items-center justify-between px-2">
              <div class="flex items-center space-x-2">
                ...
                <span class="text-xs font-medium text-slate-600 dark:text-slate-400">Licence du Projet</span>
              </div>
